...
function litProgs.targets(defaultDef, lpDef)
  ...
  print('lpDef.autoGenerated: '..prettyPrint(lpDef.autoGenerated))
  for aSrcType, someSrcFiles in pairs(lpDef.autoGenerated) do
    lpDef[aSrcType] = someSrcFiles
    print(aSrcType..' : '..prettyPrint(someSrcFiles))
