...
test_that("we can get/set Predator/Prey Coefficients", {
  ...
  expect_false(.C_setPredatorCoefficients(test, 50, c(1, 2), c(0.1, 0.2), c(1.1, 1.2)))
  expect_false(.C_setPreyCoefficients(test, 50, c(3, 4), c(0.3, 0.4), c(1.3, 1.4)))
  #
  expect_false(.C_setPredatorCoefficients(test, 2, c(101, 2), c(10.1, 10.2), c(11.1, 11.2)))
  expect_false(.C_setPreyCoefficients(test, 2, c(103, 4), c(1.3, 1.4), c(2.3, 2.4)))
  #
  expect_true(.C_setPredatorCoefficients(test, 5, c(5, 6), c(0.5, 0.6), c(1.5, 1.6)))
  expect_true(.C_setPreyCoefficients(test, 5, c(7, 8), c(0.7, 0.8), c(1.7, 1.8)))
  #
  expect_true(.C_setPredatorCoefficients(test, 6, c(9, 10), c(0.9, 1.0), c(1.9, 2.0)))
  expect_true(.C_setPreyCoefficients(test, 6, c(11, 12), c(1.1, 1.2), c(2.1, 2.2)))
  #
