...
test_that("C_getSpeciesValues gets the correct values", {
  test <- .C_newSpeciesTable(10)
  expect_error(.C_setSpeciesValues(test, 50, c(0.1, 0.2, 1.0, 0.3, 0.4, 0.5)))
  expect_true(.C_setSpeciesValues(test, 5, c(0.1, 0.2, 1.0, 0.4, 0.5, 0.6)))
  expect_true(.C_setSpeciesValues(test, 6, c(0.1, NA_real_, 0.0, 0.4, 0.5, 0.6)))
