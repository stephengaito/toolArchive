...
test_that("C_getSpeciesValues gets the correct values", {
  test <- .C_newSpeciesTable(10)
  expect_error(.C_setSpeciesValues(test, 50, c(0.1, 0.2, 1.0, 0.3, 0.4, 0.5, 0.6)))
  expect_true(.C_setSpeciesValues(test, 5, c(0.1, 0.2, 1.0, 0.4, 0.5, 0.6, 0.7)))
  expect_true(.C_setSpeciesValues(test, 6, c(0.1, NA_real_, 0.0, 0.4, 0.5, 0.6, 0.7)))
  ...
  expect_equal(values[6], 0.0)
  expect_equal(values[7], 0.0)
  ...
  expect_equal(values[6], 0.6)
  expect_equal(values[7], 0.7)
...
test_that("we can get/set Predator/Prey Coefficients", {
  ...
  expect_error(.C_setPredatorCoefficients(test, 50, c(1, 2), c(0.1, 0.2), c(1.1, 1.2), c(2.1, 2.2), c(0, 1)))
  expect_error(.C_setPreyCoefficients(test, 50, c(3, 4), c(0.3, 0.4), c(1.3, 1.4), c(2.3, 2.4), c(10, 11)))
  #
  expect_false(.C_setPredatorCoefficients(test, 2, c(101, 2), c(10.1, 10.2), c(11.1, 11.2), c(12.1, 12.2), c(20, 21)))
  expect_false(.C_setPreyCoefficients(test, 2, c(103, 4), c(1.3, 1.4), c(2.3, 2.4), c(3.3, 3.4), c(30, 31)))
  #
  expect_true(.C_setPredatorCoefficients(test, 5, c(5, 6), c(0.5, 0.6), c(1.5, 1.6), c(2.5, 2.6), c(40, 41)))
  expect_true(.C_setPreyCoefficients(test, 5, c(7, 8), c(0.7, 0.8), c(1.7, 1.8), c(2.7, 2.8), c(50, 51)))
  #
  expect_true(.C_setPredatorCoefficients(test, 6, c(9, 10), c(0.9, 1.0), c(1.9, 2.0), c(2.9, 3.0), c(60, 61)))
  expect_true(.C_setPreyCoefficients(test, 6, c(11, 12), c(1.1, 1.2), c(2.1, 2.2), c(3.1, 3.2), c(70, 71)))
  #
  ...
  expect_equal(values[[4]][1], 2.5)
  expect_equal(values[[4]][2], 2.6)
  expect_equal(length(values[[5]]), 2)
  expect_equal(values[[5]][1], 40)
  expect_equal(values[[5]][2], 41)
  #
  ...
  expect_equal(length(values[[4]]), 2)
  expect_equal(values[[4]][1], 3.1)
  expect_equal(values[[4]][2], 3.2)
  expect_equal(length(values[[5]]), 2)
  expect_equal(values[[5]][1], 70)
  expect_equal(values[[5]][2], 71)
})